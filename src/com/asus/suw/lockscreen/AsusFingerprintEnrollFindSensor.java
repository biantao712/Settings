...
import com.android.settings.fingerprint.FingerprintFindSensorAnimation;
import com.android.settings.fingerprint.FingerprintEnrollEnrolling;
/**
 * Activity explaining the fingerprint sensor location for fingerprint enrollment.
 */
public class AsusFingerprintEnrollFindSensor extends AsusFingerprintEnrollBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSubContentView(getContentView());
