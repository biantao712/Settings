...
public class RunningServices extends SettingsPreferenceFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(buttonBar != null) {
            ...
            buttonBar.addButton(1, R.drawable.asusres_btn_display, res.getString(R.string.develop_asusres_btn_display));
            buttonBar.getButton(1).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (showingBackground) {
                        ...
                        buttonBar.getButton(1).setButton(1, R.drawable.asusres_btn_display, res.getString(R.string.develop_asusres_btn_display_cache));
                    } else {
                        mRunningProcessesView.mAdapter.setShowBackground(true);
                        buttonBar.getButton(1).setButton(1, R.drawable.asusres_btn_display, res.getString(R.string.develop_asusres_btn_display));
                    }
