...
public class AppStorageSettings extends AppInfoWithHeader
    ...
    private void initiateClearUserData() {
        ...
        boolean res = false;
        try {
            res = ActivityManagerNative.getDefault().clearApplicationUserData(packageName, mClearDataObserver, UserHandle.getUserId(mAppEntry.info.uid));
    ...
    protected AlertDialog createDialog(int id, int errorCode) {
        switch (id) {
            case DLG_CLEAR_DATA:
                ...
                String text = getActivity().getResources().getString(R.string.clear_data_hint);
   ...
   /*         return new AlertDialog.Builder(getActivity())
            ...
            case DLG_CANNOT_CLEAR_DATA:
                return createCannotClearDialog();
...
/*                return new AlertDialog.Builder(getActivity())
    ...
    private AlertDialog createCannotClearDialog(){
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        builder.setNeutralButton(R.string.dlg_ok,
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        mClearDataButton.setEnabled(false);
                        //force to recompute changed value
        ...
        View view1 = LayoutInflater.from(getActivity()).inflate(R.layout.cnasusres_alertdialog_content_with_title, null);
        TextView title = (TextView) view1.getRootView().findViewById(R.id.alertdialog_title);
        title.setText(getActivity().getResources().getString(R.string.clear_failed_dlg_title));
        TextView message = (TextView) view1.getRootView().findViewById(R.id.alertdialog_message);
        String text = getActivity().getResources().getString(R.string.clear_failed_dlg_text);
        message.setText(text);
    ...
    public void onPackageSizeChanged(String packageName) {
        if (mAppEntry == null || mAppEntry.info == null) return;
