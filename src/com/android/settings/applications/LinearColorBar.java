...
public class LinearColorBar extends LinearLayout {
    // +++ ckenken @ 20170111 VZ_REQ_UI_15706
    static final private String TAG = "LinearColorBar";
    // --- ckenken @ 20170111 VZ_REQ_UI_15706
    ...
    // +++ ckenken @ 20170111 VZ_REQ_UI_15706
    private double mWarningLineRation = -1;
    // --- ckenken @ 20170111 VZ_REQ_UI_15706
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (left < right) {
           ...
           // canvas.drawRect(mRect, mPaint);
            canvas.drawRoundRect(0,mRect.top,mRect.right,mRect.bottom,((mRect.bottom - mRect.top)/2),((mRect.bottom - mRect.top)/2), mPaint);

            mPaint.setColor(pickColor(mMiddleColor, REGION_YELLOW));
            canvas.drawRoundRect(0,mRect.top,right2,mRect.bottom,((mRect.bottom - mRect.top)/2),((mRect.bottom - mRect.top)/2), mPaint);

            mPaint.setColor(pickColor(mLeftColor, REGION_RED));
            //canvas.drawRect(mRect, mPaint);
            canvas.drawRoundRect(0,mRect.top,right0,mRect.bottom,((mRect.bottom - mRect.top)/2),((mRect.bottom - mRect.top)/2), mPaint);
        }

        // +++ ckenken @ 20170111 VZ_REQ_UI_15706
        Log.d(TAG, "mWarningLineRation = " + mWarningLineRation);
        if (mWarningLineRation > 0) {
            left = (int) (mWarningLineRation * getWidth());
            mRect.left = left;
            mRect.right = left + 2;
...
// +++ AMAX @ 20170119 7.1.1 Porting
    // +++ ckenken @ 20170111 VZ_REQ_UI_15706
    public void setWarningLineLocationRatio(double inputRatio) {
        mWarningLineRation = inputRatio;
    }
    // --- ckenken @ 20170111 VZ_REQ_UI_15706
// --- AMAX @ 20170119 7.1.1 Porting
}
