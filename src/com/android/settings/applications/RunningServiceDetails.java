...
public class RunningServiceDetails extends InstrumentedFragment
    ...
    void addServicesHeader() {
        if (mNumServices == 0) {
            mServicesHeader = (View)mInflater.inflate(R.layout.cn_category_header,
                    mAllDetails, false);
            TextView textView = (TextView)mServicesHeader.findViewById(R.id.title);
    ...
    void addProcessesHeader() {
        if (mNumProcesses == 0) {
            mProcessesHeader = (View)mInflater.inflate(R.layout.cn_category_header,
                    mAllDetails, false);
            TextView textView = (TextView)mProcessesHeader.findViewById(R.id.title);
    ...
    void addServiceDetailsView(RunningState.ServiceItem si, RunningState.MergedItem mi,
        ...
        if (!inclDetails) {
            ...
            description = (TextView)root.findViewById(R.id.comp_description_for_bg);
        } else{
            root.findViewById(R.id.comp_description_for_bg).setVisibility(View.GONE);
            description = (TextView)root.findViewById(R.id.comp_description);
        }
...
//        TextView description = (TextView)root.findViewById(R.id.comp_description);
        ...
        if (isService && mi.mUserId != UserHandle.myUserId()) {
            ...
            detail.mReportButton.setText(R.string.cn_report);
            // check if error reporting is enabled in secure settings
	    // AsusAnalytics
            try {
                if (( "com.asus.as".equals(bi.mPackageInfo.packageName)) && detail.mManageIntent == null) {
                    detail.mStopButton.setEnabled(false);
                }
            } catch (Exception e) {
            }
    ...
    public View onCreateView(
        ...
        mSnippetViewHolder = new ViewHolder(mSnippet);
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            switch (id) {
                case DIALOG_CONFIRM_STOP: {
                    ...
                    title.setText(getActivity().getResources().getString(R.string.runningservicedetails_stop_dlg_title));
                    TextView message = (TextView) view1.getRootView().findViewById(R.id.alertdialog_message);
                    String text = getActivity().getResources().getString(R.string.asus_runningservicedetails_stop_dlg_text);
 ...
 /*                   return new AlertDialog.Builder(getActivity())
                            ...
                            .setMessage(getActivity().getString(R.string.asus_runningservicedetails_stop_dlg_text))
