 ...
 */
public class CNAppListPreference extends CheckBoxPreference {
    public interface OnClickListener {
        public abstract void onRadioButtonClicked(CNAppListPreference emiter);
    }

    private OnClickListener mListener = null;

    public CNAppListPreference(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        setLayoutResource(R.layout.cn_default_assist_preference);
        setWidgetLayoutResource(R.layout.preference_widget_radiobutton);
    }

    public CNAppListPreference(Context context, AttributeSet attrs) {
        this(context, attrs, com.android.internal.R.attr.checkBoxPreferenceStyle);
    }

    public CNAppListPreference(Context context) {
        this(context, null);
    }
