...
class EditPinPreference extends CustomEditTextPreference {
    private static final int MAX_PIN_LENGTH = 8;//ashan_yang@asus.com TT315666
    ...
    protected void onBindDialogView(View view) {
        ...
        if (editText != null) {
            ...
            //ashan_yang@asus.com TT315666
            editText.setFilters(new InputFilter[]{new InputFilter.LengthFilter(MAX_PIN_LENGTH)});
            editText.setSelection(editText.getText().length());
            //---
        }
        // Add CN Message For PIN Dialog.
        mMessage = (TextView) view.findViewById(R.id.alertdialog_message);
