...
public class Index {
        ...
        try {
            ...
            if (count > 0) {
                while (cursor.moveToNext()) {
                    ...
                    int userId = 0;
                    try {
                        userId = cursor.getInt(COLUMN_INDEX_RAW_USER_ID);
    ...
    public static String buildSearchSQL(String query, String[] colums, boolean withOrderBy) {
        StringBuilder sb = new StringBuilder();
    ...
    private static String buildSearchSQLForColumn(String query, String[] columnNames) {
        StringBuilder sb = new StringBuilder();
        sb.append("SELECT ");
        ...
        sb.append(" WHERE ");
        sb.append(buildSearchWhereStringForColumns2(query, columnNames));

        return sb.toString();
    }

    private static String buildSearchWhereStringForColumns(String query, String[] columnNames) {
    ...
    private static String buildSearchWhereStringForColumns2(String query, String[] columnNames) {
        final StringBuilder sb = new StringBuilder(buildSearchLikeStringForColumns(query, columnNames));
/*        sb.append(" MATCH ");
        DatabaseUtils.appendEscapedSQLString(sb,
                buildSearchMatchStringForColumns(query, columnNames));*/
        sb.append(" AND ");
    ...
    private static String buildSearchLikeStringForColumns(String query, String[] columnNames) {
    ...
    private static String buildSearchMatchStringForColumns(String query, String[] columnNames) {
        final String value = "*" + query + "*";
        StringBuilder sb = new StringBuilder();
        final int count = columnNames.length;
        for (int n = 0; n < count; n++) {
    ...
    private void indexFromProvider(Context context, SQLiteDatabase database, String localeStr,
        ...
        if (rawList != null) {
            ...
            for (int i = 0; i < rawSize; i++) {
                ...
                //For search asus flip cover on settings to get correct icon
                if (className != null && className.equals(AsusCoverSettings.class.getName())) {
                    iconResId = raw.iconResId;
                }
