...
public final class Ranking {
    ...
    public static final int RANK_EASY_MODE = 25;
    //ASUS Flip Cover
    public static final int RANK_FLIP_COVER = 26;
    public static final int RANK_ZENMOTION = 27;
    public static final int RANK_KIDS_MODE = 28;
...
//        sRankMap.put(AdvancedWifiSettings.class.getName(), RANK_WIFI);
        ...
        sRankMap.put(TetherSettings.class.getName(), RANK_WIFI);
        ...
        sRankMap.put(MoreSettings.class.getName(), RANK_WIRELESS);

        // Display
        sRankMap.put(DisplaySettings.class.getName(), RANK_DISPLAY);
        sRankMap.put(ScreenZoomSettings.class.getName(), RANK_DISPLAY);

        // Wallpapers
//        sRankMap.put(WallpaperTypeSettings.class.getName(), RANK_WALLPAPER);
        sRankMap.put(AsusThemeAppSettings.class.getName(), RANK_WALLPAPER);
...
//        sRankMap.put(ZenModeVisualInterruptionSettings.class.getName(), RANK_NOTIFICATIONS);
        sRankMap.put(CNStatusBarNotificationEntry.class.getName(),RANK_NOTIFICATIONS);
        sRankMap.put(CNNotificationManagerEntry.class.getName(),RANK_NOTIFICATIONS);
        // Storage
        ...
        sRankMap.put(CNManageAppsEntry.class.getName(), RANK_APPS);
        sRankMap.put(AdvancedAppSettings.class.getName(), RANK_APPS);
        sRankMap.put(SpecialAccessSettings.class.getName(), RANK_APPS);
        sRankMap.put(AsusTwinAppsSettings.class.getName(), RANK_APPS);
        sRankMap.put(ManagePermissionSettings.class.getName(), RANK_APPS);
...
//        sRankMap.put(ScanningSettings.class.getName(), RANK_LOCATION);
        ...
        sRankMap.put(FingerprintSettings.class.getName(), RANK_SECURITY);
        sRankMap.put(AsusLockScreenSettings.class.getName(),RANK_SECURITY);


        // Accounts
        sRankMap.put(AccountSettings.class.getName(), RANK_ACCOUNT);
        sRankMap.put(AsusCNAccountSettings.class.getName(), RANK_ACCOUNT);
...
//        sRankMap.put(PrintSettingsFragment.class.getName(), RANK_PRINTING);
        ...
        sRankMap.put(SystemUpdateSettings.class.getName(), RANK_DEVICE_INFO);

        // Easy Mode
        //sRankMap.put(AsusEasyLauncherSettings.class.getName(), RANK_EASY_MODE);

        //ASUS Flip Cover
        sRankMap.put(AsusCoverSettings.class.getName(), RANK_FLIP_COVER);

        //ZenMotion
        /*
        sRankMap.put(AsusZenMotionSettings.class.getName(), RANK_ZENMOTION);
        sRankMap.put(AsusTouchSettings.class.getName(), RANK_ZENMOTION);
        sRankMap.put(AsusMotionSettings.class.getName(), RANK_ZENMOTION);
        */
        //Kids Mode
        sRankMap.put(AsusKidsLauncherSettings.class.getName(), RANK_KIDS_MODE);
