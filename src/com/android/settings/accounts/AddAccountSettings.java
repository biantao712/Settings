...
public class AddAccountSettings extends Activity {
    ...
    static final String FILTER_NONE_AUTHORITIES = "FILTER_NONE_AUTHORITIES";
    ...
    private void requestChooseAccount() {
        ...
        intent.putExtra(FILTER_NONE_AUTHORITIES,
                getIntent().getBooleanExtra(FILTER_NONE_AUTHORITIES, true));
