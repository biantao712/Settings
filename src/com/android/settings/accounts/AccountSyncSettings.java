    ...
    public Dialog onCreateDialog(final int id) {
        ...
        if (id == REALLY_REMOVE_DIALOG) {
            dialog = new AlertDialog.Builder(getActivity())
                ...
                .setMessage(R.string.asus_really_remove_account_message)
...
/*        final Activity activity = getActivity();
    ...
    private void setFeedsState() {
        ...
        for (int i = 0, count = getPreferenceScreen().getPreferenceCount(); i < count; i++) {
            ...
            if (syncIsFailing){
                syncPref.setSummary(R.string.sync_is_failing);
            }
        }
    ...
    private void initButtonBar(){
        ...
        if (!syncActive)
            buttonBar.addButton(1, R.drawable.cn_sync_account_button,
                    getActivity().getResources().getString(R.string.sync_menu_sync_now));
        else
            buttonBar.addButton(1, R.drawable.cn_sync_account_button,
        ...
        if (!RestrictedLockUtils.hasBaseUserRestriction(getPrefContext(),
                UserManager.DISALLOW_MODIFY_ACCOUNTS, mUserHandle.getIdentifier())) {
            buttonBar.addButton(2, R.drawable.cn_unload_button,
                    getActivity().getResources().getString(R.string.remove_account_label));
