...
public class ChooseAccountActivity extends SettingsPreferenceFragment {
    ...
    private void onAuthDescriptionsUpdated() {
        ...
        for (int i = 0; i < mAuthDescs.length; i++) {
            ...
            boolean addAccountPref = !getIntent().getBooleanExtra(AddAccountSettings.FILTER_NONE_AUTHORITIES, true);
            ...
            } else if (mAuthorities == null || (mAuthorities != null && mAuthorities.length == 0)){
                addAccountPref = true;
            }
