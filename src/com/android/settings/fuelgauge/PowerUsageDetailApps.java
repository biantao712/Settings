 ...
 */
public class PowerUsageDetailApps extends PowerUsageBase {

    private static final boolean DEBUG = false;

    private static final boolean USE_FAKE_DATA = false;

    static final String TAG = "PowerUsageDetailApps";
    ...
    public void onCreate(Bundle icicle) {
        ...
        if(isCnMobileManagerExist()){
            Intent intent = new Intent();
            intent.setClassName(POWER_SAVER_PACKAGE,POWER_SAVER_CLASS);
            intent.putExtra("to_fragment",1);
            startActivity(intent);
            finish();
        }


        addPreferencesFromResource(R.xml.power_usage_detail_apps);
    ...
    private void initButtonBar(){
		...
		if(mButtonBar != null) {
			...
			mButtonBar.addButton(1, R.drawable.bluetooth_refresh_button, getString(R.string.menu_stats_refresh));
    ...
    private void addNotAvailableMessage() {
        ...
        if (notAvailable == null) {
            ...
            notAvailable.setLayoutResource(R.layout.asusres_preference_material_nodivider);
...
//        updatePreference(mHistPref);
        ...
        */
        ...
        if(addedSome)
        	setPreferenceGroupChildrenLayout(mAppListGroup, R.layout.cnasusres_preference_power_gauge_item,
        			R.layout.cnasusres_preference_power_gauge_item_nodivider);
