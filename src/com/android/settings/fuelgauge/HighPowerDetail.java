...
public class HighPowerDetail extends DialogFragment implements OnClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mBackend.createDozeModeBackend(getActivity().getApplicationContext());
    ...
    public static CharSequence getSummary(Context context, String pkg) {
        ...
        powerWhitelist.createDozeModeBackend(context.getApplicationContext());

        boolean isSysWhitelisted = powerWhitelist.isSysWhitelisted(pkg);
//                || powerWhitelist.isAsusWhitelisted(pkg, context.getApplicationContext());
        return context.getString(isSysWhitelisted ? R.string.high_power_system
