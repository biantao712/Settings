...
public class Status extends SettingsPreferenceFragment {
    ...
    private static final String KEY_LAST_FACTORY = "last_factory_reset_time";
    private Preference mLastFactory;
    ...
    public void onCreate(Bundle icicle) {
        ...
        mLastFactory = findPreference(KEY_LAST_FACTORY);
        if (!AsusTelephonyUtils.isVerizon()) {
            Log.d(TAG, "onCreate(): Remove Last factory data reset preference since isVerizon=" + AsusTelephonyUtils.isVerizon());
            removePreferenceFromScreen(KEY_LAST_FACTORY);
            mLastFactory = null;
        }
        if (mLastFactory != null) {
            if(isLastFactoryFileExist()){
                setSummaryText(KEY_LAST_FACTORY, getLastFactoryTime());
            }else {
                setSummaryText(KEY_LAST_FACTORY, Utils.getFirstInstallTime(getContext()));
            }
        }
        // --- Kevin_Chiou@20151217: Verizon VZ_REQ_UI_15743
    ...
    // +++ Kevin_Chiou Verizon VZ_REQ_UI_15743
    private boolean isLastFactoryFileExist() {
    ...
    private String getLastFactoryTime() {
        return Settings.System.getString(this.getContentResolver() , LAST_FACTORY_RESET_DATA);
    }
    // --- Kevin_Chiou Verizon VZ_REQ_UI_15743
