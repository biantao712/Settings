...
//                result.value, result.units).toString()));
        ...
        final String total = Formatter.formatFileSize(context, mTotalSize);
//        mSummary.setSummary(getString(R.string.storage_volume_summary, used, total));
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        //ASUS: Only show migrate button for Adopted Volume
        migrate.setVisible( mVolume.getDisk() != null
                && mVolume.getDisk().isAdoptable()
