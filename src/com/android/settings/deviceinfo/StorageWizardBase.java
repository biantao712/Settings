...
public abstract class StorageWizardBase extends Activity {
    ...
    protected void setBodyText(int resId, String... args) {
        ((TextView) findViewById(R.id.storage_wizard_body)).setText(
                TextUtils.expandTemplate(getText(resId), args).toString());
    }

    protected void setBodyTextForCDATA(int resId, String... args) {
        ((TextView) findViewById(R.id.storage_wizard_body)).setText(
                Html.fromHtml(TextUtils.expandTemplate(getText(resId), args).toString()));
    }
    ...
    protected void setSecondaryBodyText(int resId, String... args) {
        ...
        secondBody.setText(TextUtils.expandTemplate(getText(resId), args).toString());
        secondBody.setVisibility(View.VISIBLE);
    }

    protected void setSecondaryBodyTextForCDATA(int resId, String... args) {
        final TextView secondBody = ((TextView) findViewById(R.id.storage_wizard_second_body));
        secondBody.setText(Html.fromHtml(TextUtils.expandTemplate(getText(resId), args).toString()));
        secondBody.setVisibility(View.VISIBLE);
    }
