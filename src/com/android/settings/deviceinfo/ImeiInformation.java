        ...
        if (phone != null) {
            if (phone.getPhoneType() == TelephonyManager.PHONE_TYPE_CDMA) {
                ...
                if (phone.getLteOnCdmaMode() == PhoneConstants.LTE_ON_CDMA_TRUE) {
                    ...
                    setSummaryText(KEY_ICC_ID, AsusTelephonyUtils.formatIdentityDisplay(phone.getIccSerialNumber()));
                    setSummaryTextAsDigit(KEY_IMEI, AsusTelephonyUtils.formatIdentityDisplay(phone.getImei()));
...
// +++ AMAX @ 20170119 7.1.1 Porting
    ...
    public void onResume() {
        ...
        try {
            android.widget.ListView tabLV = null;
            int resId = getResources().getIdentifier("list", "id", "android");
            tabLV = (android.widget.ListView) getActivity().findViewById(resId);
