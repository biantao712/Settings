...
public final class SmsDefaultDialog extends AlertActivity implements
    ...
    private boolean buildDialog(String packageName) {
        ...
        // +++ Mark_Huang@20160105: Verizon VZ_REQ_UI_Folder_37450
        p.mTitle = (!AsusTelephonyUtils.isVerizon())? getString(R.string.sms_change_default_dialog_title) :
                getString(R.string.vzw_sms_change_default_dialog_title);
        // --- Mark_Huang@20160105: Verizon VZ_REQ_UI_Folder_37450
        ...
        if (mNewSmsApplicationData != null) {
            ...
            if (oldSmsApplicationData != null) {
                ...
                if (!AsusTelephonyUtils.isVerizon()) {
                    ...
                    p.mMessage = getString(R.string.vzw_sms_change_default_dialog_text,
                            mNewSmsApplicationData.getApplicationName(this),
                            oldSmsApplicationData.getApplicationName(this));
                }
                // --- Mark_Huang@20160105: Verizon VZ_REQ_UI_Folder_37450
