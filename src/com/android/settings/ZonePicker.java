...
public class ZonePicker extends ListFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        list.setDivider(getContext().getDrawable(R.drawable.list_divider_line));
        list.setDividerHeight(1);
        Utils.forcePrepareCustomPreferencesList(container, view, list, false);
        list.setScrollIndicators(0);
        return view;
    }
...
//    }
    ...
    public void setSorting(boolean sortByTimezone) {
    ...
    private static class MyComparator implements Comparator<Map<?, ?>> {
        ...
        public int compare(Map<?, ?> map1, Map<?, ?> map2) {
            ...
            if(mSortingKey.equals(ZoneGetter.KEY_DISPLAYNAME)){
