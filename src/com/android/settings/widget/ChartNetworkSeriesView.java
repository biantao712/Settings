...
public class ChartNetworkSeriesView extends View {
    ...
    private void generatePath() {
        ...
        // +++ AMAX @ 20170119 7.1.1 Porting
        // +++ Mark_Huang@20160721: Fix empty stats graph problem by showing graph if there is any data found.
        if (mStats == null || mStats.size() <= 0) {
            Log.d(TAG, "generatePath(): return since no data found");
            return;
        }
        // --- Mark_Huang@20160721: Fix empty stats graph problem by showing graph if there is any data found.
        Log.d(TAG, "generatePath(): mStats size = " + mStats.size());
        // --- AMAX @ 20170119 7.1.1 Porting
    ...
    protected void onDraw(Canvas canvas) {
        Log.d(TAG, "onDraw()");  // +++ AMAX @ 20170119 7.1.1 Porting
        int save;
