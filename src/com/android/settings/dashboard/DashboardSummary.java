...
public class DashboardSummary extends InstrumentedFragment
    ...
    public static final String[] ENTRY_TOGGLE = {
            Settings.WifiSettingsActivity.class.getName(),
            Settings.BluetoothSettingsActivity.class.getName(),
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        mDashboard.setOnItemClickListener(new FocusRecyclerView.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                //Log.d("Jack", "*************Click position " + position);
            }
            ...
            public void onDeleteClick(int position) {
                ...
                //Log.d("Jack", "*************Delete ");
                Object item = mAdapter.getItem(mAdapter.getItemId(position));
                if (item instanceof Condition) {
                    ((Condition) item).silence();
                }else{
                    //mAdapter.reMoveSuggestion((Tile) mAdapter.getItem(mAdapter.getItemId(position)));
                }
            }
        });
    ...
    private List<DashboardCategory> removeHideCategory(List<DashboardCategory> categories){
        ...
        for(DashboardCategory category:categories){
            if (!category.key.equals(getContext().getResources().getString(R.string.category_key_hide))){
    ...
    private class SuggestionLoader extends AsyncTask<Void, Void, List<Tile>> {
        ...
        protected void onPostExecute(List<Tile> tiles) {
            ...
            categories = removeHideCategory(categories);
