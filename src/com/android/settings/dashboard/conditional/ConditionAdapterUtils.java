...
public class ConditionAdapterUtils {
    ...
    public static void bindViews(final Condition condition,
        ...
        final Button conditionSwitch = (Button) view.itemView.findViewById(R.id.condition_switch);
        ...
        if (actions.length > 0){
            conditionSwitch.setVisibility(View.VISIBLE);
            conditionSwitch.setText(actions[0]);
            conditionSwitch.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ...
                    condition.onActionClick(0);
                }
            });
        }else {
            conditionSwitch.setVisibility(View.GONE);
        }
