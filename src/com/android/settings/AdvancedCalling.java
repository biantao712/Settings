...
public class AdvancedCalling extends SettingsPreferenceFragment {

    private static final String TAG = "AdvancedCalling";
    public static final String CALL_SETTINGS_PACKAGE = "com.android.phone";
    public static final String CALL_SETTINGS_CLASS = "com.android.phone.AdvancedCallingSettings";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "onCreate(): startActivity on Phone for intent = " + intent);
