...
public class CaptionPropertiesFragment extends SettingsPreferenceFragment
    ...
    private static final String PREF_STANDARD = "standard";
    private static final String CAPTIONING_SWITCH_PREFERENCE = "accessibility_captioning_switch_preference";
    ...
    private PreferenceCategory mStandard;

    private SwitchPreference mCaptioningPreference;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mStandard.setEnabled(enabled);
        mCustom.setEnabled(enabled);
...
//    }
    ...
    private void initializeAllPreferences() {
        ...
        mCaptioningPreference = (SwitchPreference) findPreference(CAPTIONING_SWITCH_PREFERENCE);
        mCaptioningPreference.setOnPreferenceChangeListener(this);
        mCaptioningPreference.setChecked(Settings.Secure.getInt(getActivity().getContentResolver(), Settings.Secure.ACCESSIBILITY_CAPTIONING_ENABLED,0) == 1);
        ...
        mStandard = (PreferenceCategory) findPreference(PREF_STANDARD);
        mShowingCustom = true;
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        if (mCaptioningPreference == preference) {
            boolean checked = mCaptioningPreference.isChecked();
            Settings.Secure.putInt(getActivity().getContentResolver(), Settings.Secure.ACCESSIBILITY_CAPTIONING_ENABLED, checked ? 1 : 0);
            mStandard.setEnabled(checked);
            mCustom.setEnabled(checked);
            if (mPreviewText != null) {
                mPreviewText.setVisibility(checked ? View.VISIBLE : View.INVISIBLE);
            }
            return true;
