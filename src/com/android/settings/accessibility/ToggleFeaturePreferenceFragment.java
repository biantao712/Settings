    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSummaryPreference = new Preference(getPrefContext()) {
            ...
            public void onBindViewHolder(PreferenceViewHolder view) {
                ...
                summaryView.setTextColor(Color.rgb(158, 158, 158));
                summaryView.setLineSpacing(15,1);
                summaryView.setText(getSummary());
                sendAccessibilityEvent(summaryView);
                summaryView.setBackgroundColor(ContextCompat.getColor(getPrefContext(), R.color.category_divider_background));
            }
        ...
        mSwitchPreference = new SwitchPreference(getPrefContext());
