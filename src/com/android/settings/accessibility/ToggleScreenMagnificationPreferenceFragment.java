...
//        mVideoPreference.setLayoutResource(R.layout.video_preference);
        ...
        //mVideoPreference.setOrder(1);
        mSummaryPreference.setOrder(2);
        //preferenceScreen.addPreference(mVideoPreference);

        mSwitchPreference.setTitle(getPrefContext().getResources().getString(R.string.accessibility_screen_magnification_title));
    ...
    protected void onPreferenceToggled(String preferenceKey, boolean enabled) {
        Settings.Secure.putInt(getContentResolver(),  Settings.Secure.ACCESSIBILITY_DISPLAY_MAGNIFICATION_ENABLED, enabled ? 1 : 0);
    }
