...
//        }
    ...
    // +++ Millie_Chang@20160504: TT-791395
    protected void removeDialogAllowStateLoss(int dialogId) {
        if (mDialogFragment != null && mDialogFragment.getDialogId() == dialogId) {
            mDialogFragment.dismissAllowingStateLoss();
        }
        mDialogFragment = null;
...
//            return;
        ...
        boolean exec = getFragmentManager().executePendingTransactions();
        if(f == null){
            if (getFragmentManager().findFragmentByTag(DIALOG_FRAGMENT_TAG) != null) {
    			f = (DialogFragment) getFragmentManager().findFragmentByTag(DIALOG_FRAGMENT_TAG);
            }
        }
    ...
    public static class SettingsDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            Dialog dialog = ((DialogCreatable) mParentFragment).onCreateDialog(mDialogId);
            //tim++
            if(dialog != null){
    ...
    public void setPreferenceGroupChildrenLayout(PreferenceGroup group, int layoutResId, int layoutNoDividerResId){
    	setPreferenceGroupChildrenLayout(group, layoutResId, layoutNoDividerResId, false);
    }
    //tim--
