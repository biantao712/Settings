...
public class WifiCallingSettings extends SettingsPreferenceFragment
    ...
    private final PhoneStateListener mPhoneStateListener = new PhoneStateListener() {
        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            ...
            // +++ ckenken (ChiaHsiang_Kuo) @ 20161227 Fix NullPointerException
            if (activity == null) {
                Log.d(TAG, "onCallStateChanged(): activity is null!");
                return;
            }
            // --- ckenken (ChiaHsiang_Kuo) @ 20161227 Fix NullPointerException
            ...
            Log.d(TAG, "onCallStateChanged isNonTtyOrTtyOnVolteEnabled = " + isNonTtyOrTtyOnVolteEnabled + ", switchBar.getSwitch().isChecked() = " + switchBar.getSwitch().isChecked() + ", isWfcEnabled = " + isWfcEnabled + ", state = " + state);  // +++ AMAX @ 20170119 7.1.1 Porting
        }
    };
    ...
    private void showAlert(Intent intent) {
        Log.d(TAG, "showAlert");  // +++ AMAX @ 20170119 7.1.1 Porting
    ...
    private BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.d(TAG, "mIntentReceiver action = " + action);  // +++ AMAX @ 20170119 7.1.1 Porting
    ...
    public void onResume() {
        ...
        if (ImsManager.isWfcEnabledByPlatform(context)) {
            Log.d(TAG, "onResume tm.listen LISTEN_CALL_STATE");  // +++ AMAX @ 20170119 7.1.1 Porting
        ...
        Log.d(TAG, "onResume wfcEnabled = " + wfcEnabled + ", ImsManager.isWfcEnabledByUser(context) = " + ImsManager.isWfcEnabledByUser(context) + ", ImsManager.isNonTtyOrTtyOnVolteEnabled(context) = " + ImsManager.isNonTtyOrTtyOnVolteEnabled(context));  // +++ AMAX @ 20170119 7.1.1 Porting
    }
    ...
    public void onPause() {
        ...
        if (mValidListener) {
            ...
            Log.d(TAG, "onPause tm.listen LISTEN_NONE");  // +++ AMAX @ 20170119 7.1.1 Porting
            TelephonyManager tm = (TelephonyManager) getSystemService(Context.TELEPHONY_SERVICE);
    ...
    private void updateButtonWfcMode(Context context, boolean wfcEnabled,
        ...
        Log.d(TAG, "updateButtonWfcMode wfcEnabled = " + wfcEnabled +", wfcMode = " + wfcMode);  // +++ AMAX @ 20170119 7.1.1 Porting
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mButtonWfcMode) {
            ...
            Log.d(TAG, "onPreferenceChange buttonMode = " + buttonMode + ", currentWfcMode = " + currentWfcMode);  // +++ AMAX @ 20170119 7.1.1 Porting
