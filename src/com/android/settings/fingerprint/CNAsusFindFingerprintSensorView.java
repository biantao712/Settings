...
public class CNAsusFindFingerprintSensorView extends View {
    ...
    public static final String  SENSOR_FRONT2 = "front_woh";
    public static final String  SENSOR_BACK = "back";

    public static final String  SENSOR_SHAPE_SQUARE = "square";
    public static final String  SENSOR_SHAPE_ROUND = "round";

    private String mMode = SENSOR_FRONT;

    public CNAsusFindFingerprintSensorView(Context context) {
        super(context);
        init(context);
    }

    public CNAsusFindFingerprintSensorView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public CNAsusFindFingerprintSensorView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        if(SENSOR_FRONT.equals(mMode) || SENSOR_FRONT2.equals(mMode)){
            ...
            }else if(SENSOR_SHAPE_ROUND.equals(shape)){
                setGifResource(context, R.drawable.fingerprint_tutorial_back_round);
            }else {
