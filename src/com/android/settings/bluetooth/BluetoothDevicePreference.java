...
public final class BluetoothDevicePreference extends Preference implements
    ...
    //    if (cachedDevice.getBondState() == BluetoothDevice.BOND_BONDED) {
            ...
            if (! um.hasUserRestriction(DISALLOW_CONFIG_BLUETOOTH)) {
                if (cachedDevice.getBondState() == BluetoothDevice.BOND_BONDED) {
		    setWidgetLayoutResource(R.layout.preference_connected_bluetooth);
		}else{
    ...
    public void onBindViewHolder(PreferenceViewHolder view) {
        ...
        if (mCachedDevice.getBondState() == BluetoothDevice.BOND_BONDED) {
            ...
            if (deviceDetails != null) {
                deviceDetails.setBackground(null);
                deviceDetails.setOnClickListener(null);
                deviceDetails.setEnabled(false);
            }
        }
        //+++ suleman
    ...
    private void pair() {
        if (!mCachedDevice.startPairing()) {
            ...
            data.iconResId = R.drawable.ic_bt_unknown;
            data.enabled = true;
    ...
    private Pair<Integer, String> getBtClassDrawableWithDescription() {
            ...
            switch (btClass.getMajorDeviceClass()) {
                case BluetoothClass.Device.Major.COMPUTER:
                    ...
                    if (deviceClass == BluetoothClass.Device.COMPUTER_HANDHELD_PC_PDA
                            || deviceClass == BluetoothClass.Device.COMPUTER_PALM_SIZE_PC_PDA) {
                        return new Pair<Integer, String>(R.drawable.ic_bt_pda, COMPUTER);    
                    } else {
        ...
        if (BluetoothPairedUtil.supportToPairWithBtDock() && mCachedDevice.getName().equals(BluetoothPairedUtil.DEVICE_NAME_DA01_SPK)) {
            return new Pair<Integer, String>(R.drawable.ic_bt_speaker, HEADPHONE);
        }
        ...
        return new Pair<Integer, String>(R.drawable.ic_bt_unknown, BLUETOOTH);
    }
}
