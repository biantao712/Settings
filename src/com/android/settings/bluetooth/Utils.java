...
public final class Utils {
    ...
    static void showError(Context context, String name, int messageResId) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.asusres_preference_error_dialog_view, null);
        TextView mMessage = (TextView) view.getRootView().findViewById(R.id.error_message);
        mMessage.setText(message);
