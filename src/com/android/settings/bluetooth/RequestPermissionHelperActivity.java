    ...
    void createDialog() {
        ...
        if (mEnableOnly) {
            ...
            if (mTimeout == BluetoothDiscoverableEnabler.DISCOVERABLE_TIMEOUT_NEVER) {
                p.mMessage = getString(R.string.asus_bluetooth_ask_enablement_and_lasting_discovery);
            } else {
                p.mMessage = getString(R.string.asus_bluetooth_ask_enablement_and_discovery, mTimeout);
            }
        }
