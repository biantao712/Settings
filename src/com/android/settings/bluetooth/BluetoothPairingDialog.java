...
public final class BluetoothPairingDialog extends AlertActivity implements
    ...
    private View createView() {
        ...
        //+++ suleman
        TextView myTitle = (TextView) view.findViewById(R.id.my_title);
        myTitle.setText(R.string.bluetooth_pair_request);
        TextView deviceViewCaption = (TextView) view.findViewById(R.id.device_caption);
        deviceViewCaption.setText(R.string.bluetooth_devices);
        TextView deviceViewContent = (TextView) view.findViewById(R.id.device_subhead);
        //--- suleman
        ...
        contactSharing.setText(R.string.bluetooth_allow_access);
        //contactSharing.setText(getString(R.string.bluetooth_pairing_shares_phonebook,
        //        getDeviceName()));
        if (mPbapClientProfile != null && mPbapClientProfile.isProfileReady()) {
            contactSharing.setVisibility(View.GONE);
        ...
        if (pairingContent != null) {
            ...
            deviceViewCaption.setVisibility(View.VISIBLE);
            deviceViewContent.setVisibility(View.VISIBLE);
            deviceViewContent.setText(getDeviceName());
        }
...
*/  
        ...
        AlertDialog.Builder confirmDialog = new AlertDialog.Builder(this)
            .setView(createView())
            .setPositiveButton(R.string.bluetooth_pairing_accept, this)
            .setNegativeButton(R.string.bluetooth_pairing_decline,this);
        ...
        dialog.getButton(DialogInterface.BUTTON_POSITIVE).setTextColor(Color.parseColor("#03bed4"));
        //--- 
    }
    ...
    private String getDeviceName() {
        return Html.fromHtml(Html.escapeHtml(mCachedDeviceManager.getName(mDevice))).toString();
    }
}
