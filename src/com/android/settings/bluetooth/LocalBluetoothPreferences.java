...
final class LocalBluetoothPreferences {
    ...
    //+++ suleman
    private static final String KEY_SWITCH_PREF_IS_ON = "switch_pref_is_on";
    private static final String KEY_CHECK_TIME_DIALOG_TIME = "check_time_dialog_time";
    //---
    ...
    //+++ suleman
    static void saveSwitchIsOn(Context context, boolean isOn) {
        SharedPreferences.Editor editor = getSharedPreferences(context).edit();
        editor.putBoolean(KEY_SWITCH_PREF_IS_ON, isOn);
        editor.apply();
    }

    static boolean getSwitchIsOn(Context context) {
        return getSharedPreferences(context).getBoolean(KEY_SWITCH_PREF_IS_ON,
                false);
    }
    static void setCheckTime(Context context, String time) {
        SharedPreferences.Editor editor = getSharedPreferences(context).edit();
        editor.putString(KEY_CHECK_TIME_DIALOG_TIME, time);
        editor.apply();
    }

    static String getCheckTime(Context context, String mDefault) {
        return getSharedPreferences(context).getString(KEY_CHECK_TIME_DIALOG_TIME,
                mDefault);
    }
