...
public final class DevicePickerFragment extends DeviceListPreferenceFragment {
   ...
   public void onPrepareOptionsMenu(Menu menu) {
        ...
        isDiscovering = mLocalAdapter.isDiscovering();
        int textId = isDiscovering ? R.string.bluetooth_searching_for_devices :
            R.string.bluetooth_search_for_devices;

        menu.add(Menu.NONE, MENU_ID_REFRESH, 0, textId)
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        PreferenceGroup deviceListGroup = (PreferenceGroup) findPreference("bt_device_list");
        if (deviceListGroup != null) {
            deviceListGroup.setSelectable(false);
            deviceListGroup.setTitle(R.string.bluetooth_preference_found_devices);
        }
    }
    ...
    public void onPause() {
       ...
       mStartScanOnResume = true; // triggle start scan when resume
    }
