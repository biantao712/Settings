...
public final class DeviceProfilesSettings extends DialogFragment implements
    ...
    private static final int BLUETOOTH_OTHER_DEVICE_NAME_MAX_LENGTH_BYTES = 248;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        deviceName.setFilters(new InputFilter[] {new Utf8ByteLengthFilter(BLUETOOTH_OTHER_DEVICE_NAME_MAX_LENGTH_BYTES), new RemoveSpecialCharFilter(false)});
    ...
    public void onResume() {
        ...
        if (mCachedDevice != null) {
            ...
            //addPreferencesForProfiles();//Suleman
            refresh();
        }
    }
