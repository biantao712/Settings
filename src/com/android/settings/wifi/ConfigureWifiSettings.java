...
public class ConfigureWifiSettings extends SettingsPreferenceFragment
    ...
    private static final String KEY_AVOID_BAD_CONNECTIONS = "avoid_bad_connections";
    private static final String KEY_WIFI_MANAGE_NETWORK = "wifi_manage_network";
    ...
    private static final String KEY_AUTO_DIRECT_TO_ATTWIFI = "auto_direct_to_attwifi";
    
    private static final String KEY_CATEGORY_CONNECT = "wifi_advanced_category_connect";
    //tim--
...
//        }
        PreferenceGroup connectGroup = (PreferenceGroup) findPreference(KEY_CATEGORY_CONNECT);
...
//        if(Utils.isVerizon()) {
//            SwitchPreference avoidBadConnections =
//                (SwitchPreference) findPreference(KEY_AVOID_BAD_CONNECTIONS);
//                avoidBadConnections.setChecked(Settings.Global.getInt(getContentResolver(),
//                        Settings.Global.WIFI_NETWORKS_AVOID_BAD_CONNECTIONS, 0) == 1);
//            Preference manageNetworkPref = findPreference(KEY_WIFI_MANAGE_NETWORK);
//            manageNetworkPref.setEnabled(mWifiManager.isWifiEnabled());
//        } else {
//        	removePreference(KEY_AVOID_BAD_CONNECTIONS);
//        	removePreference(KEY_WIFI_MANAGE_NETWORK);
//        }

        if(findPreference(KEY_WIFI_ASSISTANT) != null){
	        ...
	        if (UserManager.get(context).isAdminUser() && !scorers.isEmpty()) {
	        	...
	        	connectGroup.removePreference(mWifiAssistantPreference);
	        }
        }
        ...
        if (sleepPolicyPref != null) {
            ...
            if(findPreference(KEY_WIFI_ASSISTANT) == null)
                sleepPolicyPref.setLayoutResource(R.layout.cnasusres_preference_parent_nodivider);
        }
    ...
    public static class WpsFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
        	Dialog dialog = new WpsDialog(getActivity(), mWpsSetup);
