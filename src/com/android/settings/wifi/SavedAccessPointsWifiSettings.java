...
public class SavedAccessPointsWifiSettings extends SettingsPreferenceFragment
    ...
    private Preference mSelectedPref;
    private String saved_ssid = "";
    // Instance state key
    private static final String SAVE_DIALOG_ACCESS_POINT_STATE = "wifi_ap_state";
    private String SAVE_CLICK_PREFERENCE = "save_click_preference";
    @Override
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            if(savedInstanceState.containsKey(SAVE_CLICK_PREFERENCE)) {
                saved_ssid = savedInstanceState.getString(SAVE_CLICK_PREFERENCE);
            }
        }
    }
    ...
    private void initPreferences() {
        ...
        for (int i = 0; i < accessPointsSize; ++i){
            ...
            if(preference.getAccessPoint().getSsid().toString().equals(saved_ssid)) {
                mSelectedPref = preference;
                saved_ssid = "";
            }
        ...
        setPreferenceGroupChildrenLayout(preferenceScreen, R.layout.asusres_preference_material,
    ...
    public Dialog onCreateDialog(int dialogId) {
        switch (dialogId) {
            case WifiSettings.WIFI_DIALOG_ID:
                ...
                mDialog = createSavedWifiDialog();
//                mDialog = new WifiDialog(getActivity(), this, mDlgAccessPoint,
//                        WifiConfigUiBase.MODE_VIEW, true /* hide the submit button */,WifiQRCodeUtils.getApQRCodeString(mSelectedAccessPoint,mWifiManager));
                return mDialog;
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if (mDialog != null && mDialog.isShowing()) {
            if (mDlgAccessPoint != null) {
                ...
                outState.putString(SAVE_CLICK_PREFERENCE,((LongPressAccessPointPreference)mSelectedPref).getAccessPoint().getSsid().toString());
            }
        }
    }
...
//            getPreferenceScreen().removePreference(mSelectedPref);
...
//            getPreferenceScreen().removePreference(mSelectedPref);
    ...
    private Dialog createSavedWifiDialog()
    {
        View view1 = LayoutInflater.from(getActivity()).inflate(R.layout.wifi_saved_item_dialog, null);
        if(mDlgAccessPoint != null){
	        TextView title = (TextView) view1.getRootView().findViewById(R.id.alertdialog_title);
	        title.setText(mDlgAccessPoint.getSsid());
	        
	        TextView security = (TextView) view1.getRootView().findViewById(R.id.security);
	        security.setText(mDlgAccessPoint.getSecurityString(false));
        }
        
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity())
        		.setView(view1)
                .setPositiveButton(R.string.wifi_menu_forget,
