 ...
 */
public class CNRestrictedSwitchPreference extends SwitchPreference {
    RestrictedPreferenceHelper mHelper;
    boolean mUseAdditionalSummary = false;
    String mRestrictedSwitchSummary = null;

    public CNRestrictedSwitchPreference(Context context, AttributeSet attrs,
        ...
        if (mUseAdditionalSummary) {
            setLayoutResource(R.layout.cn_restricted_switch_preference);
            useAdminDisabledSummary(false);
        }
    }

    public CNRestrictedSwitchPreference(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public CNRestrictedSwitchPreference(Context context) {
        this(context, null);
    }
...
//            restrictedIcon.setVisibility(isDisabledByAdmin() ? View.VISIBLE : View.GONE);
            restrictedIcon.setVisibility(View.GONE);
        }
