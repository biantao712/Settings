...
public class AccountPreference extends Preference {
    ...
    public AccountPreference(Context context, Account account, Drawable icon,
        ...
        setLayoutResource(R.layout.cn_account_preference_manage);
        if (showTypeIcon) {
            setIcon(icon);
        } else {
...
//                res = R.drawable.ic_settings_sync;
                res = R.drawable.asusres_btn_synchronization_n;
                break;
            case SYNC_DISABLED:
//                res = R.drawable.ic_sync_grey_holo;
                res = R.drawable.asusres_icon_prohibit_n;
                break;
            case SYNC_ERROR:
//                res = R.drawable.ic_sync_red_holo;
                res = R.drawable.asusres_icon_problem_n;
                break;
            default:
//                res = R.drawable.ic_sync_red_holo;
                res = R.drawable.asusres_icon_problem_n;
