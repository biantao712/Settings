...
public class DevelopmentSettings extends RestrictedSettingsFragment
    ...
    //+++ suleman
    private static final String DEBUG_BUGREPORT_CATEGORY_KEY = "debug_bugreport_category";
    ...
    private static final String DEBUG_SWITCH_PREFERENCE_KEY = "debug_switch_preference";
    //---
    ...
    private CNRestrictedSwitchPreference mKeepScreenOn;
    ...
    public void onCreate(Bundle icicle) {
        ...
        //+++ suleman
        final PreferenceGroup debugBugreportCategory = (PreferenceGroup)
                findPreference(DEBUG_BUGREPORT_CATEGORY_KEY);
        ...
        mKeepScreenOn = (CNRestrictedSwitchPreference) findAndInitSwitchPref(KEEP_SCREEN_ON);
        ...
        // Remove OEM Unlock for all projects
        debugBugreportCategory.removePreference(findPreference(ENABLE_OEM_UNLOCK));
        ...
        mSwitchPref = (SwitchPreference) findPreference(DEBUG_SWITCH_PREFERENCE_KEY);
        ...
        try {
            ...
            if (!mountService.isConvertibleToFBE()) {
                debugBugreportCategory.removePreference(findPreference(KEY_CONVERT_FBE));
        ...
        if (mColorModePreference.getColorModeCount() < 2) {
            debugBugreportCategory.removePreference(findPreference(KEY_COLOR_MODE));
        ...
        if (getResources().getBoolean(R.bool.config_enableColorTemperature)) {
            ...
            debugBugreportCategory.removePreference(findPreference(COLOR_TEMPERATURE_KEY));
            mColorTemperaturePreference = null;
        }
        //+++ suleman
        //debugBugreportCategory.removePreference(mBugreport);
        //debugBugreportCategory.removePreference(hdcpChecking);
        //debugBugreportCategory.removePreference(convertFbePreference);
        //debugBugreportCategory.removePreference(mWebViewProvider);
        //debugBugreportCategory.removePreference(mWebViewMultiprocess);
        //debugBugreportCategory.removePreference(mOtaDisableAutomaticUpdate);
        debugBugreportCategory.removePreference(mColorModePreference);
        //debugDebuggingCategory.removePreference(mLogpersist);

        debugDebuggingCategory.removePreference(mBugreportInPower);

        //debugNetworkingCategory.removePreference(mBluetoothDisableAbsVolume);

        //debugDrawingCategory.removePreference(mForceRtlLayout);
        //debugDrawingCategory.removePreference(findPreference("density"));

        //debugApplicationsCategory.removePreference(mForceAllowOnExternal);
        //debugApplicationsCategory.removePreference(mForceResizable);
        //debugApplicationsCategory.removePreference(findPreference(SHORTCUT_MANAGER_RESET_KEY));
        //---
    }
...
*/
      ...
      //  }
        ...
        if(buttonBar != null) {
            ...
            buttonBar.addButton(1, R.drawable.asusres_btn_reply, res.getString(
                            R.string.develop_asusres_btn_reply));
...
//---
    ...
    public void creatDialog() {
        ...
        View view = layoutInflater.inflate(R.layout.asusres_development_reset_dialog_view, null);
    ...
    public void onResume() {
        ...
        //+++ suleman
        mSwitchPref.setChecked(mLastEnabledState); 
        if (mLastEnabledState) {
            mSwitchPref.setTitle(R.string.develop_asusres_switch_open);
        } else {
            mSwitchPref.setTitle(R.string.develop_asusres_switch_close);
        }
    ...
    private void updateDebuggerOptions() {
        ...
        if (mDebugApp != null && mDebugApp.length() > 0) {
            ...
            mDebugAppPref.setSummary(getResources().getString(R.string.cn_debug_app_not_set));
    ...
    private void updateMockLocation() {
        ...
        if (!TextUtils.isEmpty(mMockLocationApp)) {
            ...
            mMockLocationAppPref.setSummary(getString(R.string.cn_mock_location_app_not_set));
        }
    }
    ...
    private void updateShowTouchesOptions() {
        updateSwitchPreference(mShowTouches,
                Settings.System.getInt(getActivity().getContentResolver(),
                        Settings.System.SHOW_TOUCHES, Build.TYPE.equals("eng") ? 1 : 0) != 0);
    }
    ...
    private void updateLogdSizeValues() {
        if (mLogdSize != null) {
            ...
            String[] summaries = getResources().getStringArray(R.array.cn_select_logd_size_summaries);
    ...
    private void updateAnimationScaleValue(int which, ListPreference pref) {
        try {
            ...
            scale = (which == 0 || which == 1) ? scale * 2.0f : scale;
            if (scale != 1) {
                mHaveDebugSettings = true;
            }
  ...
  */  }
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        if (preference == mEnableAdb) {
            if (mEnableAdb.isChecked()) {
                ...
                mTitle.setText(R.string.adb_warning_title);
                mMessage.setText(R.string.adb_warning_message);
            ...
            TextView mTitle = (TextView) view.getRootView().findViewById(R.id.alertdialog_title);
            TextView mMessage = (TextView) view.getRootView().findViewById(R.id.alertdialog_message);
            mTitle.setText(R.string.develop_asusres_perference_cancel_usb_title);
            mMessage.setText(R.string.adb_keys_warning_message);
            ...
            mAdbKeysDialog = new AlertDialog.Builder(getActivity())
                        ...
                        .setView(view)
                        .show();
            Window window = mAdbKeysDialog.getWindow();
            WindowManager.LayoutParams lp = window.getAttributes();
            lp.width = WindowManager.LayoutParams.MATCH_PARENT;
            lp.height = WindowManager.LayoutParams.WRAP_CONTENT;
            lp.gravity = Gravity.BOTTOM;
            ...
            intent.putExtra(AppPicker.EXTRA_PREFERENCE_NAME,
                    mMockLocationAppPref.getTitle());
            ...
            writeLegacyDhcpClientOptions();//+++ suleman
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (HDCP_CHECKING_KEY.equals(preference.getKey())) {
            ...
            return true;
        } else  if (preference == mOpenGLTraces) {//+++ suleman
       ...
       boolean isChecked = (Boolean) newValue;
        ...
        if (isChecked != mLastEnabledState) {
            if (isChecked) {
                ...
                TextView mTitle = (TextView) view.getRootView().findViewById(R.id.alertdialog_title);
                TextView mMessage = (TextView) view.getRootView().findViewById(R.id.alertdialog_message);
                mTitle.setText(R.string.dev_settings_warning_title);
                mMessage.setText(getActivity().getResources().getString(
                                R.string.dev_settings_warning_message));
                ...
                Window window = mEnableDialog.getWindow();
                WindowManager.LayoutParams lp = window.getAttributes();
                lp.width = WindowManager.LayoutParams.MATCH_PARENT;
                lp.height = WindowManager.LayoutParams.WRAP_CONTENT;
                lp.gravity = Gravity.BOTTOM;
                ...
                setPrefsEnabledState(mLastEnabledState);
                mSwitchPref.setTitle(R.string.develop_asusres_switch_close);
                mSwitchPref.setChecked(isChecked);
            }
        }
