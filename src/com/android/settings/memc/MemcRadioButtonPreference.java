 ...
 */
public class MemcRadioButtonPreference extends CheckBoxPreference {
    public interface OnClickListener {
        public abstract void onRadioButtonClicked(MemcRadioButtonPreference emiter);
    }

    private OnClickListener mListener = null;

    public MemcRadioButtonPreference(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        setLayoutResource(R.layout.memc_preference);
        setWidgetLayoutResource(R.layout.preference_widget_radiobutton);
    }

    public MemcRadioButtonPreference(Context context, AttributeSet attrs) {
        this(context, attrs, getIdentifier(context, "style", "Widget.CompoundButton.RadioButton"));
    }

    public MemcRadioButtonPreference(Context context) {
        this(context, null);
    }
