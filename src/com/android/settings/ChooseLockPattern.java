...
public class ChooseLockPattern extends SettingsActivity {
    ...
    private static final String TAG = "ChooseLockPattern_NF";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setTheme(R.style.Theme_PasswordPattern);        // remove tag of requestWindowFeature(Window.FEATURE_NO_TITLE); and show action bar(see SettingsDrawerActivity.java theme.
        ...
        CharSequence msg = getText(R.string.lockpassword_choose_your_pattern_header_nf);
        setTitle(msg);
        LinearLayout layout = (LinearLayout) findViewById(R.id.content_parent);
        layout.setFitsSystemWindows(false);
        getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR); // show Action Bar in 7.1.1
    ...
    public static class ChooseLockPatternFragment extends InstrumentedFragment
        ...
        protected void setRightButtonEnabled(boolean enabled) {
            if(mFooterRightButton != null)
            {
                ...
                mFooterRightButton.setTextColor(csList);
            }
        }
        ...
        protected LockPatternView.OnPatternListener mChooseNewLockPatternListener =
                ...
                private void patternInProgress() {
                    if(mHeaderText != null)
                    {
                        mHeaderText.setText(R.string.lockpattern_recording_inprogress_nf);
                    }
                    if(mFooterText != null)
                    {
                        mFooterText.setText("");
                    }
                    if(mFooterLeftButton != null)
                    {
        ...
        protected enum Stage {
            ...
            ChoiceTooShort(
                    R.string.lockpattern_recording_incorrect_too_short_nf,
            ...
            NeedToConfirm(
                    ...
                    ID_EMPTY_MESSAGE, true),
            ConfirmWrong(
                    R.string.lockpattern_need_to_unlock_wrong_nf,
                    LeftButtonMode.Cancel, RightButtonMode.ConfirmDisabled,
                    ID_EMPTY_MESSAGE, true),
            ChoiceConfirmed(
                    R.string.lockpattern_pattern_confirmed_header_nf,
        ...
        public void onViewCreated(View view, Bundle savedInstanceState) {
            ...
            if(mFooterText == null)
            {
                Log.d(TAG," footer text is null");
            }

            mFooterLeftButton = (TextView) view.findViewById(R.id.cancel_button);
            mFooterRightButton = (TextView) view.findViewById(R.id.next_button);
            if(mFooterLeftButton == null || mFooterRightButton == null) {
                Log.d(TAG,"error,Footer buttons are null");
            }
            else
            {
        ...
        public void handleLeftButton() {
            if (mUiStage.leftMode == LeftButtonMode.Retry) {
                ...
                Log.d(TAG,"<TODO>:: unknown status of left button");
