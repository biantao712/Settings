...
public class DeviceAdminSettings extends ListFragment {
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        //+++ suleman
        final int uid = dpi.getActivityInfo().applicationInfo.uid;
        final String pkg = dpi.getActivityInfo().applicationInfo.packageName;
        try {
            int mCurSysAppOpMode = mAppOps.checkOp(AppOpsManager.OP_SYSTEM_ALERT_WINDOW, uid, pkg);
            if (AppOpsManager.MODE_ERRORED != mCurSysAppOpMode) {
    ...
    class PolicyListAdapter extends BaseAdapter {
        ...
        private void bindView(View view, DeviceAdminInfo item) {
            ...
            if (isActiveAdmin(item)){
                vh.description.setText(R.string.security_device_admin_active);
            } else {
                vh.description.setText(R.string.security_device_admin_no_active);
            }
            //+++ suleman
            //try {
