...
import com.android.settings.applications.DevelpAppViewHolder;
...
public class AppPicker extends ListActivity {
    ...
    public static final String EXTRA_PREFERENCE_NAME = "com.android.settings.extra.PREFERENCE_NAME";
    ...
    protected void onCreate(Bundle icicle) {
        ...
        //+++ suleman
        mPreferenceName = getIntent().getStringExtra(EXTRA_PREFERENCE_NAME);
        getActionBar().setDisplayHomeAsUpEnabled(true);
        getActionBar().setTitle(mPreferenceName);
        getActionBar().setDisplayShowHomeEnabled(false);
        getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR);
        getWindow().setStatusBarColor(getColor(R.color.action_bar_background));
        //getWindow().setBackgroundDrawableResource(R.color.category_divider_background);
        //---
    ...
    public class AppListAdapter extends ArrayAdapter<MyApplicationInfo> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            DevelpAppViewHolder holder = DevelpAppViewHolder.createOrRecycle(mInflater, convertView, info.info);
