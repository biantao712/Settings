...
import com.android.settings.notification.ringtone.CNRingtoneUtils;
...
public class RingtonePreference extends Preference {
	...
	private static final String ACTION_CN_RINGTONE_PICKER = "android.intent.action.CN_RINGTONE_PICKER";
    ...
    public RingtonePreference(Context context, AttributeSet attrs) {
        ...
        mShowSilent = a.getBoolean(com.android.internal.R.styleable.RingtonePreference_showSilent,
                true);
		if(CNRingtoneUtils.isSpecificSKU("CN")){
			setIntent(new Intent(ACTION_CN_RINGTONE_PICKER));
		}else{
