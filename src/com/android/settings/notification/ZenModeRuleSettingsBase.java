...
public abstract class ZenModeRuleSettingsBase extends ZenModeSettingsBase
    ...
    public void onCreate(Bundle icicle) {
        ...
        mZenMode.setEntries(new CharSequence[] {
                getString(R.string.zen_mode_option_important_interruptions2),
        ...
        mZenMode.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(Preference preference, Object newValue) {
                ...
                //BEGIN chunghung_lin@asus.com for Verizon, disable in AMAX tree
                if ((Utils.isVerizonSKU()) && (zenMode == NotificationManager.INTERRUPTION_FILTER_NONE)) {
                    Toast.makeText(mContext, R.string.zen_mode_no_interruptions_warning, Toast.LENGTH_SHORT).show();
                }
                //END chunghung_lin@asus.com
                return true;
            }
        });
