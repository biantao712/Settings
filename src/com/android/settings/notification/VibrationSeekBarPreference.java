...
public class VibrationSeekBarPreference extends SeekBarPreference {
    private static final String TAG = "VibrationSeekBarPreference";
    ...
    public VibrationSeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        setLayoutResource(R.layout.preference_vibration_seekbarpreference);
    }
