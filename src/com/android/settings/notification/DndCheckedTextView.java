...
/**
 * Copy from android.widget.CheckedTextView.java
 * Only change default value of mCheckMarkGravity.
 * by chilung_chen@asus.com
 *
 ...
 */
public class DndCheckedTextView extends TextView implements Checkable {
    ...
    private int mCheckMarkGravity = Gravity.START; // chilung_chen@asus.com
    ...
    public DndCheckedTextView(Context context) {
        this(context, null);
    }

    public DndCheckedTextView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.checkedTextViewStyle);
    }

    public DndCheckedTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public DndCheckedTextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mCheckMarkGravity = a.getInt(R.styleable.CheckedTextView_checkMarkGravity, Gravity.START); // chilung_chen@asus.com
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(DndCheckedTextView.class.getName());
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        info.setClassName(DndCheckedTextView.class.getName());
