...
public class RedactionInterstitial extends SettingsActivity {
    private static final String TAG = "RedactionInterstitial";
    ...
    public static class RedactionInterstitialFragment extends SettingsPreferenceFragment
        ...
        public void onCreate(Bundle savedInstanceState) {
            try {
                ...
                Log.d(TAG,"fordebug force exit this to support new featuer");
            } catch (Exception ee) {
                Log.d(TAG, "Error of oncreate");
            }
        }
        ...
        public void onResume() {
            ...
            checkNotificationFeaturesAndSetDisabled(mRedactSensitiveButton,
                    KEYGUARD_DISABLE_SECURE_NOTIFICATIONS);
            loadFromSettings();
            Log.d(TAG,"fordebug NewFeature force exit this fragment");
            finish();
        }
