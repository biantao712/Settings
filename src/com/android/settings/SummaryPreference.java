...
public class SummaryPreference extends Preference {
    ...
    public void setAmount(String amount) {
        ...
        if (mAmount != null && mUnits != null) {
            setTitle(Html.fromHtml(TextUtils.expandTemplate(getContext().getText(R.string.memory_size_available),
                    mAmount, mUnits).toString()));
        }
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        // +++ ckenken VZ_REQ_UI_15706
        colorBar.setWarningLineLocationRatio(mWarningLineRation);
        // --- ckenken VZ_REQ_UI_15706
