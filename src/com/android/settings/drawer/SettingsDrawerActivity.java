...
public class SettingsDrawerActivity extends Activity {
    ...
    private static ArraySet<ComponentName> sTileHideList = new ArraySet<>();//chunghung_lin@asus.com.tw
    ...
    private final static String sHidedCategory = "com.android.settings.category.hide";//jack_qi
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (!theme.getBoolean(android.R.styleable.Theme_windowNoTitle, false)) {
            ...
            getWindow().setStatusBarColor(getResources().getColor(R.color.settings_default));
            //--jack_qi
            requestWindowFeature(Window.FEATURE_NO_TITLE);
        }
        super.setContentView(R.layout.cn_settings_with_drawer);//jack_qi
    ...
    public void setToolBarTitleTextGrave(int grave){
        Toolbar.LayoutParams params = new Toolbar.LayoutParams( Toolbar.LayoutParams.WRAP_CONTENT, Toolbar.LayoutParams.WRAP_CONTENT);
        //params.weight = 1.0f;
//        int leftMarginDp = 6;
//        int leftMargin = (int)(leftMarginDp * getResources().getDisplayMetrics().density);
//        params.leftMargin = leftMargin;
        params.gravity = grave;
        if (mTitleText != null) {
    ...
    //--jack_qi
    public void setActionBarBackButton(boolean enable){
        if(mActionBarBackButton != null)
    	       	mActionBarBackButton.setVisibility(enable ? View.VISIBLE : View.GONE);
    }
    ...
    public void showMenuIcon() {
        mShowingMenu = true;
        getActionBar().setHomeAsUpIndicator(R.drawable.asus_ic_drawer);
    ...
    public List<DashboardCategory> getDashboardCategories() {
        ...
        //++jack_qi
        sDashboardCategories = removeHideCategory(sDashboardCategories);
        //--jack_qi
    ...
    //chunghung_lin@asus.com.tw, this function for component is enabled, but not show in ui
    public void setHideTileUiOnly(ComponentName component, boolean hide) {
         if (hide) {
            sTileHideList.add(component);
         } else {
            sTileHideList.remove(component);
         }
         setTileEnabled(component, true);
    }
    //chunghung_lin@asus.com.tw
        ...
        protected void onPostExecute(List<DashboardCategory> dashboardCategories) {
            for (int i = 0; i < dashboardCategories.size(); i++) {
                ...
                for (int j = 0; j < category.tiles.size(); j++) {
                    ...
                    } else if (sTileHideList.contains(tile.intent.getComponent())) {//chunghung_lin@asus.com.tw
                        category.tiles.remove(j--);
                    }
                }
                if(category.tiles.size() == 0){
                    dashboardCategories.remove(i--);
                }
    ...
    private List<DashboardCategory> removeHideCategory(List<DashboardCategory> categories){
        List<DashboardCategory> noHideCategorys = new ArrayList<DashboardCategory>();
        for(DashboardCategory category:categories){
            if (!category.key.equals(sHidedCategory)){
                noHideCategorys.add(category);
            }
        }
        return noHideCategorys;
    }
    //--jack_qi
}
