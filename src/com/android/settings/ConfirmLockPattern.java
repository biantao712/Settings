...
public class ConfirmLockPattern extends ConfirmDeviceCredentialBaseActivity {
    ...
    public static final String TAG = "ConfirmLockPattern_NF";
    ...
    public static class ConfirmLockPatternFragment extends ConfirmDeviceCredentialBaseFragment
        ...
        private static final int MSG_RETURN_TO_NEED_UNLOCK_AFTER_DLEAY = 1;

        private Handler mHandler = new Handler() {
            @Override
            public void handleMessage(Message msg) {
                try {
                    if (msg.what == MSG_RETURN_TO_NEED_UNLOCK_AFTER_DLEAY) {
                        Log.d(TAG, "handle  MSG_RETURN_TO_NEED_UNLOCK_AFTER_DLEAY");
                        updateStage(Stage.NeedToUnlock);
                    } else {
                        Log.d(TAG, "<TODO>:: unknown message :" + msg.what);
                    }
                }
                catch(Exception ee)
                {
                    Log.d(TAG,"Exception in handle message :" + ee);
                }
            }
        };
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Log.d(TAG,"on Create Force set to portrait");
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            Log.d(TAG,"on create view Force set to portrait");
            getActivity().setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
            ...
            {
                Log.d(TAG,"mDetailsTextView is null");
            }
            else
            {
                mDetailsTextView.setGravity(Gravity.CENTER);
            }
            ...
            try{
                CharSequence msg = getActivity().getText(R.string.lockpassword_confirm_your_pattern_header_nf);
                getActivity().setTitle(msg);
            }
            catch(Exception ee)
            {
                Log.d(TAG,"Error of set title" + ee);
            }
...
//                        ? R.string.lockpassword_strong_auth_required_reason_restart_work_pattern_nf
//                        : R.string.lockpassword_confirm_your_pattern_generic_profile_nf;
                return R.string.lockpassword_confirm_your_pattern_generic_profile_nf;
            } else {
//                return mIsStrongAuthRequired
//                        ? R.string.lockpassword_strong_auth_required_reason_restart_device_pattern_nf
//                        : R.string.lockpassword_confirm_your_pattern_generic_nf;
                return R.string.lockpassword_confirm_your_pattern_generic_nf;
            }
        }
            ...
            switch (stage) {
                case NeedToUnlock:
                    if (mHeaderText != null) {
                        ...
                        if(mHeaderTextView != null)
                        {
                            mHeaderTextView.setText(R.string.lockpassword_confirm_your_pattern_header_nf);
                        }
                    }

                    if (mDetailsText != null) {
                        mDetailsTextView.setText(mDetailsText);
                        mHeaderTextView.setText(mDetailsText);
                    } else {
                        mDetailsTextView.setText(getDefaultDetails());
                        mHeaderTextView.setText(getDefaultDetails());
                    }
                ...
                case NeedToUnlockWrong:
                    mErrorTextView.setText(R.string.lockpattern_need_to_unlock_wrong_nf);
        ...
        private void onPatternChecked(boolean matched, Intent intent, int timeoutMs,
            ...
            if (matched) {
                ...
                if (timeoutMs > 0) {
                    ...
                    mesg.what = MSG_RETURN_TO_NEED_UNLOCK_AFTER_DLEAY;
                    mHandler.sendMessageDelayed(mesg, WRONG_PATTERN_CLEAR_TIMEOUT_MS);
                }
                if (newResult) {
                    reportFailedAttempt();
                }
        ...
        protected int getLastTryErrorMessage() {
            return R.string.lock_profile_wipe_warning_content_pattern_nf;
        }
            ...
            mCountdownTimer = new CountDownTimer(
                ...
                public void onTick(long millisUntilFinished) {
                    ...
                    mErrorTextView.setText(getString(
                            R.string.lockpattern_too_many_failed_confirmation_attempts_nf,
                            secondsCountdown));
                }
