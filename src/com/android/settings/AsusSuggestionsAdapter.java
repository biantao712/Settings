...
public class AsusSuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {

    private static final boolean DBG = false;
    private static final String LOG_TAG = "AsusSuggestionsAdapter";
    ...
    private final AsusSearchView mSearchView;
    ...
    public AsusSuggestionsAdapter(Context context, AsusSearchView searchView, SearchableInfo searchable,
        ...
        try {
            Method getActivityContext = SearchableInfo.class.getMethod("getActivityContext", Context.class);
            Context activityContext = (Context) getActivityContext.invoke(mSearchable, mContext);

            Method getProviderContext = SearchableInfo.class.getMethod("getProviderContext", Context.class, Context.class);
            mProviderContext = (Context) getProviderContext.invoke(mSearchable, mContext, activityContext);
        } catch (Exception ex) {
...
//        });
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence constraint) {
        ...
        try {
            Method getSuggestions = SearchManager.class.getMethod("getSuggestions", SearchableInfo.class, String.class, int.class);
            cursor = (Cursor) getSuggestions.invoke(mSearchManager, mSearchable, query, QUERY_LIMIT);
//            cursor = mSearchManager.getSuggestions(mSearchable, query, QUERY_LIMIT);
    ...
    private CharSequence formatUrl(Context context, CharSequence url) {
        ...
        text.setSpan(new TextAppearanceSpan(null, 0, 0, null, null),
                0, url.length(),
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        try {
            ...
            Cursor cursor = (Cursor) get(this, "mCursor");
            View v = newView(mContext, cursor, parent);
            if (v != null) {
    ...
    public static Object get(Object instance, String variableName)
    {
        ...
        CursorAdapter superInst = (CursorAdapter)targetClass.cast(instance);
        Field field;
        try {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        try {
            ...
            // Put exception string in item title
            Cursor cursor = (Cursor) get(this, "mCursor");
            final View v = newDropDownView(mContext, cursor, parent);
            if (v != null) {
        ...
        try {
            ...
            if (ContentResolver.SCHEME_ANDROID_RESOURCE.equals(scheme)) {
                ...
                try {
                    ...
                    Method getResourceId = ContentResolver.class.getMethod("getResourceId", Uri.class);
                    OpenResourceIdResult r = (OpenResourceIdResult) getResourceId.invoke(resolver, uri);
